...
class Window(QWidget):
    ...
    def initUI(self):
        ...
        self.detect_label.setFont(QFont("Roman times", 16, QFont.Bold))
        self.name_text = QtGui.QLineEdit()

        self.name_text.setText(_fromUtf8('姓名'))
        ...
        self.confidence_label.setFont(QFont("Roman times", 16, QFont.Bold))
